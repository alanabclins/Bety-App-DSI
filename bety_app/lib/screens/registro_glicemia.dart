...
import 'package:bety_sprint1/screens/glicemia.dart';
import 'package:bety_sprint1/screens/edit_glicemia_record_screen.dart';
                ...
                builder: (context, snapshot) {
                  ...
                  if (_selectedDate != null) {
                    records = records.where((record) {
                      final recordDate = (record['dataHora'] as Timestamp).toDate();
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final glicemia = Glicemia.fromFirestore(records[index]);
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => EditGlicemiaRecordScreen(
                                            user: widget.user,
                                            recordId: glicemia.id,
                                            recordData: glicemia.toFirestore(),
                                          ),
                                        ),
                                      );
                                    },
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AddGlicemiaRecordScreen(user: widget.user),
                  ),
                );
              },
